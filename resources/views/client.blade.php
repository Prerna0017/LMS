        ...
        <table style="width:95%;" class="content-table" id=myTable>
            ...
            <tr>
                ...
                <td  style="text-align:center;">
                    <a href="client_delete/{{$client->id}}"><i style="color: #ce3333;" class='del bx bx-trash'></i></a>
                    <a href="client_edit/{{$client->id}}"><i style="color: #023e8a;" class='edit bx bx-edit'></i></a>
                </td>
                <td  style="text-align:center;">
                    <a  href="create_case/{{$client->id}}"><i style="color: #f8961e;" class='bx bx-briefcase'></i></a>
                </td>
                <td  style="text-align:center;">
                    <a  href="case_details/{{$client->id}}"><i style="color: #1f7b2d;" class='bx bx-book-open'></i></a>
                </td>
            </tr>
            @endforeach
        </table>
