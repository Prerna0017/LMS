...
<?php $number=1; ?>
    <div class="container">
        <table style="width:95%;" class="content-table" id=myTable >
            ...
            {{$clientArr= DB::table('client')->where('id',$case->client_id)->where('delete_status', 0)->get();}}
            </div>
            ...
            <tr>
                    ...
                    <td style="text-align:center;">
                        <a href="case_delete/{{$case->id}}"><i style="color: #ce3333;" class='del bx bx-trash'></i></a>
                        <a href="case_edit/{{$case->id}}"><i style="color: #023e8a;" class='edit bx bx-edit'></i></a>
                    </td>
                </tr>
            @endforeach
            @endforeach
