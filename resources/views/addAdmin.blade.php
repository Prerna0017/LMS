                ...
                <form class="form" method="post" action="addAdmin_submit">
                    ...
                    <div class="user-details">
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="pan" class="input" value="{{ old('pan') }}"
                                placeholder="Enter the PAN here" required>
                            <br>
                            <span style="color:red">@error('pan'){{$message}}@enderror</span>
                            <br>
                        </div>
                        <div class="input-box">
                            <span class="details">Aadhar Number</span>
                            <input type="text" name="aadhar" class="input"
                                value="{{ old('aadhar') }}" placeholder="Enter Aadhar Card Number here" />
                            <br>
                            <span style="color:red">@error('aadhar'){{$message}}@enderror</span>
                            <br>
                        </div>
                        <div class="input-box">
                        ...
                        <div class="input-box">
                            ...
                            <input type="password" name="password_admin" class="input" value="{{ old('password_admin') }}"
