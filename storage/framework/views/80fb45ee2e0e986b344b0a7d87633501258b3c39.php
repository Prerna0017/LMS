...
<head>
    ...
    <link href="<?php echo e(asset('css/style10.css')); ?>" rel="stylesheet">
    ...
    <section class="home-section" style="background-color:#F2F6F8;">
        ...
        <div class="inputfield">
            ...
            <div class="btn">
                ...
                <?php $__currentLoopData = $detailArr2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                Client ID: <?php echo e($detail->id); ?><br>
                Client Name: <?php echo e($detail->name); ?>
        ...
        <div class="container" my-5>
            <table style="text-align:center;width:95%;" class="content-table" id=myTable>
                ...
                <?php $__currentLoopData = $detailArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td style="text-align:center;"><?php echo e($number++); ?></td>
                    <td><?php echo e($detail->id); ?></td>
                    <td><?php echo e($detail->case_desc); ?></td>
                    <td><?php echo e($detail->case_type); ?></td>
                    <td style="text-align:center;">
                        <a href="/case_delete/<?php echo e($detail->id); ?>"><i style="color: #ce3333;"
                                class='del bx bx-trash'></i></a>
                        <a href="/case_edit/<?php echo e($detail->id); ?>"><i style="color: #023e8a;"
                                class='edit bx bx-edit'></i></a>
                    </td>
                <td  style="text-align:center;">
                    <a  href="/create_bill/<?php echo e($detail->id); ?>"><i style="color: #1f7b2d;" class='bx bx-receipt'></i></a>
                </td> 
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </table>
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/case_details.blade.php ENDPATH**/ ?>