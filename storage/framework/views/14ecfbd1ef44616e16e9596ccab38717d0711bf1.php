...
<div class="sidebar">
    ...
    <section class="home-section">
        ...
        <div class="container">
            ...
            <div class="content">
                <form class="form" method="post" action="<?php echo e(route('editAdmin.update',[$addArr[0]->id])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="user-details">
                        <div class="input-box">
                            <span class="details">Admin Name</span>
                            <input type="text" name="name" class="input" value="<?php echo e($addArr[0]->name); ?>"
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="date" name="dob" class="input" value="<?php echo e($addArr[0]->dob); ?>"
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="number" name="phone" class="input" value="<?php echo e($addArr[0]->phone); ?>"
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="pan" class="input" value="<?php echo e($addArr[0]->pan); ?>"
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="aadhar" class="input"
                                value="<?php echo e($addArr[0]->aadhar); ?>" placeholder="Enter Aadhar Card Number here" />
                            <br>
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="email" name="email" class="input" value="<?php echo e($addArr[0]->email); ?>"
                                placeholder="Enter the Email-Id here" required />
                        </div>
                        <div class="input-box">
                            <span class="details">Address</span>
                            <input type="text" name="address" class="input" value="<?php echo e($addArr[0]->address); ?>"
                                placeholder="Enter the Address here" required />
                        </div>
                        <div class="input-box">
                            <span class="details">Set Password</span>
                            <input type="password" name="password_admin" class="input" value="<?php echo e($addArr[0]->password_admin); ?>"
...
</blade.php>    <?php /**PATH C:\xampp\htdocs\test3\resources\views/editAdmin.blade.php ENDPATH**/ ?>