...
<br>
        <div class="container">
            ...
            <div class="content">
                <form class="form" method="post" action="<?php echo e(route('client.update',[$clientArr[0]->id])); ?>">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?></span> -->
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="name" class="input" value="<?php echo e($clientArr[0]->name); ?>"  required>
                            <br>
                            <span style="color:red"><?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="coordinator_name" class="input" id="txtAnother"
                                value="<?php echo e($clientArr[0]->coordinator_name); ?>"/>
                            <br>
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="date" name="dob" class="input" value="<?php echo e($clientArr[0]->dob); ?>"
                                 required>
                            <br>
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="email" name="email" class="input" value="<?php echo e($clientArr[0]->email); ?>"
                                required />
                        </div>
                        <div class="input-box">
                            <span class="details">Phone Number</span>
                            <input type="number" name="contact" class="input" value="<?php echo e($clientArr[0]->contact); ?>"
                                required>
                            <br>
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="address" class="input" value="<?php echo e($clientArr[0]->address); ?>"
                                required />
                        </div>
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/client_edit.blade.php ENDPATH**/ ?>