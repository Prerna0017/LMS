...
<body>
    ...
    <div class="wrapper">
        ...
        <form class="form" method="post" action="<?php echo e(route('invoice.store',[$invoiceArr[0]->id])); ?>">
            <?php echo csrf_field(); ?>

            <div class="inputfield">
                <label>Case ID</label>
                <input type="text" name="case_id" class="input" value="<?php echo e($invoiceArr[0]->id); ?>" required/>
            </div>

            <div class="inputfield">
                <label>Client ID</label>
                <input type="text" name="client_id" class="input" value="<?php echo e($invoiceArr[0]->client_id); ?>" disabled />
            </div>
            ...
            <div class="inputfield">
                ...
                <div class="custom_select">
                    <select name="subject" required>
                        <option value="">Select anyone of the Following</option>
...
<?php /**PATH C:\xampp\htdocs\test3\resources\views/create_invoice.blade.php ENDPATH**/ ?>