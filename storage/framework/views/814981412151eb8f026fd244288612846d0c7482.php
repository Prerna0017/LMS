        ...
        <table style="width:100%;" class="content-table" id=myTable>
            ...
            <?php $__currentLoopData = $billArr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr style="text-align:center;">
                    ...
                    <td><?php echo e($bill->payment_details); ?></td>
                    <td><?php echo e($bill->amount); ?></td>
                    <!-- <td><?php echo e($bill->created_at); ?></td>
                    <td><?php echo e($bill->updated_at); ?></td> -->
                    <td> 
                        <a href="bill_delete/<?php echo e($bill->id); ?>"><i style="color: #ce3333;" class='del bx bx-trash'></i></a>
                        <!-- <a href="bill_edit/<?php echo e($bill->id); ?>">EDIT</a> -->
                    </td>
                </tr>
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/bill.blade.php ENDPATH**/ ?>