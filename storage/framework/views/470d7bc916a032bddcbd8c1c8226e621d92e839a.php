    ...
    <section class="home-section" style="background-color:#F2F6F8;">
        ...
        <div>
            ...
            <section class="page-contain">
                    ...
                    <a href="handleAdminData(SA)" class="data-card" style="background-color:#7fc8f8">
                        <?php $number=0; 
                        ...
                        <h4>ADMIN</h4>
                        <p>Handle Admin Credentials in one place !!</p>
                    ...
                    <a href="financial_year_show(SA)" class="data-card" style="background-color:#fec5bb">
                        <?php $number=0; 
                        ...
                        <p>Add a new Financial Year and checkout the details !!</p>
                        <span class="link-text">
                            View All Financial Year
                            <svg width="25" height="16" viewBox="0 0 25 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    d="M17.8631 0.929124L24.2271 7.29308C24.6176 7.68361 24.6176 8.31677 24.2271 8.7073L17.8631 15.0713C17.4726 15.4618 16.8394 15.4618 16.4489 15.0713C16.0584 14.6807 16.0584 14.0476 16.4489 13.657L21.1058 9.00019H0.47998V7.00019H21.1058L16.4489 2.34334C16.0584 1.95281 16.0584 1.31965 16.4489 0.929124C16.8394 0.538599 17.4726 0.538599 17.8631 0.929124Z"
                    ...
                    <a href="AuditLog(SA)" class="data-card" style="background-color:#ffe45e">
                        
                        <!-- <h3><?php echo e($number); ?></h3> -->
                        <h3>230</h3>
                        <h4>AUDIT LOG</h4>
                        <p>Get all logs details in one place !!</p>
                        <span class="link-text">
                            View Audit Log
                            <svg width="25" height="16" viewBox="0 0 25 16" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="#" class="data-card" style="background-color:#ff6392">
                      
                        <h3>201</h3>
                        <h4>User Profile</h4>
                        <p>Handle your own credentials in one place !!</p>
                        <span class="link-text">
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/SAdashboard.blade.php ENDPATH**/ ?>