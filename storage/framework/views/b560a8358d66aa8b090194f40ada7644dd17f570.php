...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark header">
    <div class="container-fluid">
      <a class="navbar-brand" href="index2.html">LAWYER MANAGEMENT SYSTEM</a>
    </div>
  </nav>
  ...
  <div data-aos="zoom-out" class=" container ">
    <div class="blueBg">
      ...
      <div class="box signup">
        ...
        <button class="signupBtn" style="border-radius: 18px;">Sign up</button>
      </div>
    </div>
    <div class="formBx">
      ...
      <?php endif; ?>
        <form method="post" action="check">
          ...
          <button style="background-color: #ffe6a7; 
                        ...
                        font-size: 16px;" type="submit" value="Login">LOGIN</button>
...
unset($__errorArgs, $__bag); ?></span>
          ...
          <button style="background-color: #ffe6a7; 
                        ...
                        text-align: center;
                        text-decoration: none;
                        font-size: 16px;" type="submit">REGISTER</button>
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/index.blade.php ENDPATH**/ ?>