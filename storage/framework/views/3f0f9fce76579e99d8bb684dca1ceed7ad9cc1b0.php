...
<br>
        ...
        <div class="container">
            ...
            <div class="content">
                <form class="form" method="post" action="<?php echo e(route('case.update',$caseArr[0]->id)); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="user-details">
                        
                        <div class="input-box">
                            <span class="details">Client ID</span>
                            <input type="number" name="client_id" class="input" value="<?php echo e($caseArr[0]->client_id); ?>"  required>
                            <br>
                            <br>
                        </div> 
                        ...
                        <div class="input-box">
                            ...
                            <input type="text" name="case_subject" class="input" value="<?php echo e($caseArr[0]->case_subject); ?>" 
                                required>
                            <br><br>
                        </div>
                        <div class="input-box">
                            ...
                            <select required name="case_type">
                                <option value="<?php echo e($caseArr[0]->case_type); ?>"><?php echo e($caseArr[0]->case_type); ?></option>
...
unset($__errorArgs, $__bag); ?></span> -->
                    ...
                    <div style="display:inline-flex;">
                        <div class="button" style="justify-content:center;">
                            <a href="/case_details/<?php echo e($caseArr[0]->client_id); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\test3\resources\views/case_edit.blade.php ENDPATH**/ ?>